...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000279138fe000000002f09dc92(
...
class phpbbtemplatetwiglexer_00000000279138fe000000002f09dc92 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d535cfc706b6462539041 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d535cfc706e9416628781 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d535cfc7064d589052624 = array(
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, 'set_environment', array('env' => $env), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        return $this->valueHolder5d535cfc706b6462539041->set_environment($env);
    }
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        return $this->valueHolder5d535cfc706b6462539041->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        return $this->valueHolder5d535cfc706b6462539041->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d535cfc706e9416628781 = $initializer;
    }
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__get', array('name' => $name), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        if (isset(self::$publicProperties5d535cfc7064d589052624[$name])) {
            return $this->valueHolder5d535cfc706b6462539041->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d535cfc706b6462539041;
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__isset', array('name' => $name), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__unset', array('name' => $name), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;
    ...
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__clone', array(), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        $this->valueHolder5d535cfc706b6462539041 = clone $this->valueHolder5d535cfc706b6462539041;
    }

    public function __sleep()
    {
        $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, '__sleep', array(), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;

        return array('valueHolder5d535cfc706b6462539041');
    }
    ...
    {
        return $this->initializer5d535cfc706e9416628781;
    }
    ...
    {
        return $this->initializer5d535cfc706e9416628781 && ($this->initializer5d535cfc706e9416628781->__invoke($valueHolder5d535cfc706b6462539041, $this, 'initializeProxy', array(), $this->initializer5d535cfc706e9416628781) || 1) && $this->valueHolder5d535cfc706b6462539041 = $valueHolder5d535cfc706b6462539041;
    }
    ...
    {
        return null !== $this->valueHolder5d535cfc706b6462539041;
    }
    ...
    {
        return $this->valueHolder5d535cfc706b6462539041;
    }
